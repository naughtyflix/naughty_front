...
// EXTERNAL MODULE: ./src/abi.json
var abi = __webpack_require__(7);

// CONCATENATED MODULE: ./src/nodeDetailManager.js
...
var nodeDetailManager_NodeDetailManager = /*#__PURE__*/function () {
  function NodeDetailManager() {
    ...
    defineProperty_default()(this, "_network", "mainnet");
    ...
    this.nodeListContract = new external_web3_eth_contract_default.a(abi["a" /* abi */], proxyAddress);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 9:
                ...
                if (!(skipPostEpochCheck && this._network === "mainnet" && latestEpoch === this._currentEpoch)) {
                  _context.next = 12;
                  break;
                }
              ...
              case 15:
                ...
                latestEpochInfo.nodeList.map(function (nodeEthAddress) {
                  return nodeEndpointRequests.push(_this.getNodeEndpoint(nodeEthAddress)["catch"](function (_) {}));
                });
                _context.next = 22;
...
/* harmony default export */ var index_0 = __webpack_exports__["default"] = (nodeDetailManager);
