...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
  ...
  return (
    <Page>
      <iframe src="https://charts.bogged.finance/?token=0x5Ac3786CbE72B1b7B313692a37ac850545B6C749" title="BUY Naughty" height='700px' width="100%"/>
    </Page>
  )
}
...
0x36363636363636363636363636363636363636360000000000000000000000000000000000dead
